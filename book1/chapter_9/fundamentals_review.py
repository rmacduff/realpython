...
print "three: {}".format(three.split()[2] == "Python!") 
print "four: {}".format(four[0][5] == 'n' and four[0][0] == "P" and four[2][1] == "a" )
print "five: {}".format(five.get("happy") == "birthday") 
print "five: {}".format(len(five) == 1)
print"six: {}".format(len(six&{2,5,7})==3) 
print "seven: {}".format(seven == "Sun")
